...
require('lazy').setup({
    ...
    -- =============================================================================
    -- THEME CONFIGURATION (TOKYONIGHT & ELDRITCH)
    -- =============================================================================
    ...
    -- 			hl.TelescopeBorder = { bg = c.bg_dark, fg = c.purple }
    -- 			hl.Pmenu = { bg = c.bg_dark }
    -- 			-- Your custom syntax logic
    -- 			hl.Tag = { fg = "#56B6C2", bold = true }
    -- 			hl["@tag"] = { fg = "#56B6C2", bold = true }
    -- 			hl["@variable.parameter"] = { fg = "#E06C75", italic = true }
    -- 		end,
    -- 	},
    ...
    { -- 2. Eldritch
        ...
        opts = {
            transparent = true,
            styles = { comments = { italic = true }, variables = { italic = true }, keywords = { italic = true } },
            -- You can override specific highlights to use other groups or a hex color
            --- function will be called with a Highlights and ColorScheme table
            ---@param highlights Highlights
            ---@param colors ColorScheme
            on_highlights = function(highlights, colors)
                highlights.Visual = { bg = colors.visual, fg = 'none' }
                ...
                highlights.WhichKey = { bg = colors.bg_dark }
                highlights.whichKeyNormal = { bg = colors.bg_dark }
